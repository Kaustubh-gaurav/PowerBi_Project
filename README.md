...
Open Data_Jobs_Dashboard_2.0.pbix in Power BI Desktop
When prompted, update the data source path to point to your local Data_Sources/ folder
Click Refresh to load all data
Explore the dashboard using the slicers and toggle buttons


Note: Requires Power BI Desktop (free download).
